	...
	<div class="consent-overlay">
		<div class="consent-modal">
			...
			<p class="consent-lead">
				This tool provides general information about GDPR compliance. It is <strong
					>not legal advice</strong
				>.
			</p>

			<ul class="consent-list">
				<li>Responses are generated by AI and may be incomplete or inaccurate.</li>
				<li>Always consult a qualified legal professional for specific situations.</li>
				<li>This tool does not create a lawyer–client relationship.</li>
				<li>The GDPR text used may not reflect the most recent amendments.</li>
			</ul>

			<button class="consent-btn" on:click={giveConsent}>
